...
# coding=utf8
import sys
sys.path.append('/home/piarm-Ameer/ArmPi/')
import cv2
import time
import Camera
import threading
...
def run(img):
    ...
    #if the object is detected in the area, the area is considered detected until it is not
    # stays false until it is marked true elsewhere
